 ...
 */
final class Version20210208133352 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6494795A786 FOREIGN KEY (envoyeur_id) REFERENCES messages (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
