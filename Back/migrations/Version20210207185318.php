 ...
 */
final class Version20210207185318 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, envoyeur_id INT DEFAULT NULL, contenu LONGTEXT NOT NULL, INDEX IDX_DB021E964795A786 (envoyeur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
