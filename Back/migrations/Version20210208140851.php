 ...
 */
final class Version20210208140851 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649B967E626 FOREIGN KEY (receveur_id) REFERENCES message (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
